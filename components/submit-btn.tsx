...
export function SubmitBtn() {
  return (
    <button
      type="submit"
      className="submit-btn border mt-10 mb-10 border-white/[0.2] flex flex-col items-start max-w-60 w-full p-4 relative h-10 hover:border-first-200 transition-colors cc"
    >
