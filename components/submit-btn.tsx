...
export function SubmitBtn() {
  return (
    <button
      type="submit"
      className="border mt-10 mb-10 border-white/[0.2] flex flex-col items-start max-w-sm w-full max-w-52 p-4 relative h-10 hover:bg-first-200 transition-colors active:bg-first-900"
    >
