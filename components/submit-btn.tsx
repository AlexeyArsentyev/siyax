...
export function SubmitBtn() {
  return (
    <button
      type="submit"
      className="border mt-10 mb-10 border-white/[0.2] flex flex-col items-start max-w-60 w-full max-w-52 p-4 relative h-10 hover:bg-first-200 transition-colors active:bg-first-900"
    >
      ...
      <div className="w-full h-3/4 flex items-center justify-center">Contact</div>
    </button>
  );
}
